...
facultywarsFactory) {
    ...
    $scope.insertValue = facultywarsFactory.insertValue;
    $scope.loading = facultywarsFactory.loading;
    $scope.links = facultywarsFactory.links;
    $scope.openDataExampleData = facultywarsFactory.openDataExampleData;
    $scope.dbData = facultywarsFactory.dbData;
    $scope.item = facultywarsFactory.item;
